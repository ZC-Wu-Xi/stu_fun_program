...
//        System.out.println(C04SimpleStream.of(list).reduce(Integer.MAX_VALUE, Math::min));
//        System.out.println(C04SimpleStream.of(list).reduce(Integer.MIN_VALUE, Math::max));
...
//        StringJoiner collect31 = C04SimpleStream.of(list).collect(() -> new StringJoiner("-"), (joiner, t) -> joiner.add(String.valueOf(t)));
//
//        StringJoiner collect32 = C04SimpleStream.of(list)
//                .map(t -> String.valueOf(t))
//                .collect(() -> new StringJoiner("-"), StringJoiner::add);
//        System.out.println(collect31); // 1-2-3-4-5-1-2-3
//        System.out.println(collect32); // 1-2-3-4-5-1-2-3
